...
async fn test_response_headers() {
    ...
    assert_eq!(health_response.headers().get("content-type").unwrap(), "application/vnd.api+json");
    assert_eq!(not_found_response.headers().get("content-type").unwrap(), "application/vnd.api+json");
